...
import { createJob, exportUrl, getJob, getJobEvents, getJobs } from "./api";
import type { Company, Job, JobEvent } from "./types";

type Page = "Dashboard" | "Lead Search" | "Search History" | "Leads" | "Companies" | "Exports" | "Settings";
const pages: Page[] = ["Dashboard", "Lead Search", "Search History", "Leads", "Companies", "Exports", "Settings"];
...
function iconFor(page: Page) { return ({ Dashboard: "⌂", "Lead Search": "⌕", "Search History": "◷", Leads: "◫", Companies: "▦", Exports: "⇩", Settings: "⚙" } as Record<Page, string>)[page]; }
